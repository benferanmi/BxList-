...
const CarListSection = () => {
  ...
  const url =
    "https://raw.githubusercontent.com/itemsapi/itemsapi-example-data/master/items/cars.json";
  ...
  //calculations for pagination below
  ...
  if (error) {
    ...
    return <div className="result-message">loading.......</div>;
  } else {
    return (
      <div className="data-contain">
        ...
        <div className="sectionone-main">
          <Caritemlist items={currentPosts} handleCart={handleCart} />
          <Pagination
