      ...
      <div className={gridStyle}>
        {items.map(currentItems => (
              ...
              <div key={currentItems.title} className="sectionone">
                <img src={currentItems.image} alt={`${currentItems.title}/ ${currentItems.class}`} />
                 <span> 
...
<button type="button" onClick={changeStyleOne}>one</button>
<button type="button" onClick={changeStyleTwo}>two</button>
<button type="button" onClick={changeStyleThree}>three</button>
</div>
    </div>
  )
}
